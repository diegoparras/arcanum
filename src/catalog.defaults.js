...
const SERVICES = [
  ...
  },
  {
    ...
    descripcion: 'Consulta las comunicaciones publicadas en la Ventanilla Electronica.',
    categoria: 'consultas',
    wsaaService: 'e-ventanilla-int-2',
    soapNamespace: 'http://ve.tecno.afip.gov.ar/domain/service/ws',
    authStyle: 'java',
    endpoints: {
      homo: 'https://stable-middleware-tecno-ext.afip.gob.ar/ve-ws/services/veconsumer',
      prod: 'https://serviciosjava.afip.gob.ar/ve-ws/services/veconsumer',
    },
    dummyOp: 'dummy',
    rich: false,
    activacion: {
      relacionNombre: 'e-ventanilla-int-2 (Consulta de Comunicaciones)',
      pasos: pasosActivacion('e-ventanilla-int-2', [
        'Nota: confirma con tu acceso si el subservicio habilitado es de consulta (consumidor) y no de publicador.',
      ]),
